...
:keywords: AsciiDoc, Basic, Syntax
:experimental:
:table-caption!:
:example-caption!:
:figure-caption!:
...
AsciiDoc is a markup language for authoring content including articles, documentation, books, web pages, and slide decks in a texual format.
{description}

[NOTE]
====
Most features labeled "`Asciidoctor only`" can be made available to the native AsciiDoc processor by using https://github.com/asciidoctor/asciidoctor/blob/master/compat/asciidoc.conf[the AsciiDoc configuration file] from the Asciidoctor project.
====
...
.Normal
----
Paragraphs does not require any special markup in AsciiDoc.
A paragraph is just one or more lines of text.
...
Following are the other built-in admonition types:
...
----
[.lead]
This is styled as a lead paragraph (i.e., larger font).
----
...
****
Follow these parts in the Asciidoctor User Manual to understand.
...
*_bold italic dialogue_*

**__b__**old italic le**__tt__**ers

`monospace thing` and le``tt``ers

`_monospace italic dialogue` and le``__tt__``ers

`*monospace bold saying*` and le``**tt**``ers

`*_monospace bold italic sentense_*` and le``**__tt__**``ers
...
.Custom Styling
----
Did Hermione love [small]#Harry Potter#?
The world is so [small]#small#?

[big]##R##on Weisley was good at playing chess, but troubled to figure out his emotions.

[big]##B##ig thing is to respect freedom of all.
----
...
A Title is often regarded as Header in the document.

CAUTION: Keep the headers short, simple and meaningful.
...
The Emotional Technical Writer <prashantnagle@hotmail.com>
...
This document specified some of the ASCIIDOC things...
----

IMPORTANT: You must have a revision line along with the author line.
...
WARNING: When using the article doctype (the default), there must be onlu one level-0 section title (i.e., the document title) and it must be in the document header.
...
NOTE: Section title anchors depends on the default Asciidoctor stylesheet to render properly.
...
This is documentation for AREA 51.
...
Make sure you add a blank line in the source document to avoid unexpected results, such as a section title being swallowed.
...
TIP: Force two lists apart with a line comment, as the previous example demonstrates.
...
What is the answer to the Ultimate Question?:: Researching
----
...
TIP: Indent your list for proper representation.
...
.Email and IRC
----
prashantnagle@hotmail.com

mailto:prashantnagle@hotmail.com[Discuss No Working for Human]

mailto:prashantnagle@hotmail.com[Prevent SPAM! Do Not Subscribe.]
...
mailto:prashantnagle@hotmail.com[Discuss Arquillian]

mailto:prashantnagle@hotmail.com[Subscribe, Subscribe me, I want to join!]
...
[[img-sunset]]
.A mountain sunset
image::sunset.jpg[Sunset, 300, 200, link="https://www.desktopbackground.org/p/2011/01/14/141902_mountain-sunset-hd-wallpapers-picture_2560x1600_h.jpg"]
...
TIP: Control the video settings using {video-ref}[additional attributes and options] on the macro.
...
----
....
error: The requested operation returned error: 401 Forbidden search for defensive operations manual
absolutely fatal: operation initiation lost in the dodecahedron of doom
would you like to live again? y/n
....
----
...
====
Asciidoctor "draw" icons using {fontawesome-ref}[Font Awesome^] and CSS.
...
[quote, Shant]
We humans should be enjoying and spreading love around, enjoy the nature, and stop working, instead automate everything, and enjoy doing arts of any form.
...
____
[quote, Doesn't Matter Who]
We can always still be generous and experience true joy in giving for it is the ultimate gain.
____
----
====
...
- [[[seam]]] Shant. 'Seam in Action'. Manning Publications.
  2008.
----
